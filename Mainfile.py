...
with tab4:
    st.subheader("Optical telescope site testing workshop, March 19th-22nd")
    bomaconf=IMG.open("Bomaconf.jpeg")
    st.image(bomaconf)
    st.write("The DSIT workshop brought together 30 Kenyan students from the fields of Astronomy, Physics, Engineering, and Meteorology to participate in a series of lectures and activities. The 3-day workshop was hosted at the Boma hotel in Nairobi and students were introduced to the techniques and considerations needed when choosing a site and installing an optical telescope.he conference brought together global speakers leading the fields of Engineering, Meteorology, Astronomy, and Site testing. The students attended a series of lectures and activities (including an observation session with the Traveling Telescope) to gain insight into the considerations needed to choose a site for an optical observatory. This provided a networking opportunity for participants: to meet other Kenyan students in the field, and to interact with experts. The final part of the workshop involved a trip to the Mt. Kenya weather station for 5 meteorology students, led by Dr. Eddy Graham. The team hiked up with the rangers and interacted with the instrument that is collecting live data. They monitored basic weather parameters using hand-held weather instruments, and learned about the suitability of the site. The workshop concluded successfully, with great excitement amongst young Kenyan students for the future of Astronomy in the country.
")
