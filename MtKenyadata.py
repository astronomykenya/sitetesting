...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 19 11:02:25 2025
...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 11 10:27:02 2025
...
host = "tbinas.synology.me"                    #hard-coded
port = 14789
transport = paramiko.Transport((host, port))

password = "6dG?GV.Q4wI!)2"                #hard-coded
username = "weatherdata"                #hard-coded
transport.connect(username = username, password = password)

sftp = paramiko.SFTPClient.from_transport(transport)
# # Download
filepath = "/WeatherData/mtkenyadata.dat"
localpath ="/Users/lekshmigopal/MtKenyaApr.dat"
sftp.get(filepath,localpath)
filepath = '/Users/lekshmigopal/MtKenyaApr.dat'
...
print(df)
time=np.array(df.iloc[:,0]) #--- to pick out day from 1st column 
print("day from 1st column",time)
today = datetime.date.today().strftime('%Y-%m-%d')

daytoday=today[8:10]
monthtoday=today[5:7]

targetindex=[] 
day=[]       
for i in range(len(time)):
    if (time[i])[5]==monthtoday[0] and (time[i])[6]==monthtoday[1] and (time[i])[8]==daytoday[0] and (time[i])[9]==daytoday[1]:
        targetindex.append(i)
        day.append(time[i])
#daydata=(day[0])[0:10]
#print(day)
#print("indices to target are", targetindex)
#print(targetindex[0])
df=df.iloc[(targetindex[0]):(targetindex[-1]),:] 


#print("df for 27th only",df[0:10])
...
tempcolors=[]
#print("masterdfiloc1",masterdf.iloc[:,1])
...
print("tempcolors is",tempcolors)        
...
def main():
    ...
    window = GraphWin('Lab 4B', 800, 700)
        ## Title 
    title = Text(Point(400,10),"Mt. Kenya")
    title.setSize(20)
    title.draw(window)
    ...
    colormap=Text(Point(top_left_x/2,500),"Colourmaps:")
    colormap.setSize(10)
    ...
    tempcmap=Image(Point(top_left_x/2 +200,530), "Tempcmapresize.gif")
    tempcmap.draw(window)    
    
    cmaptemp = Text(Point(top_left_x/2,530),"Temperature")
    cmaptemp.setSize(10)
    cmaptemp.draw(window)  
    
    temprange1=Text(Point(top_left_x/2 +75,530),"0C")
    temprange2=Text(Point(top_left_x/2 +322,530),"40C")
    ...
    humcmap=Image(Point(top_left_x/2 +200,560), "humcmapresize.png")
    humcmap.draw(window)       
    
    cmaphum = Text(Point(top_left_x/2,560),"Rel.Humidity")
    cmaphum.setSize(10)
    cmaphum.draw(window)    
    
    humrange1=Text(Point(top_left_x/2 +78,560),"0%")
    humrange2=Text(Point(top_left_x/2 +321,560),"100%")
    ...
    glwcmap=Image(Point(top_left_x/2 +200,590), "glwcmapresize.gif")
    glwcmap.draw(window)       
    
    cmapglw = Text(Point(top_left_x/2,590),"GLW")
    cmapglw.setSize(10)
    cmapglw.draw(window)    
    
    glwrange1=Text(Point(top_left_x/2 +94,590),"310W/m^2")
    glwrange2=Text(Point(top_left_x/2 +310,590),"380W/m^2")
    ...
    clwcmap=Image(Point(top_left_x/2 +200,620), "clwcmapresize.gif")
    clwcmap.draw(window)       
    
    cmapclw = Text(Point(top_left_x/2,620),"Cloud")
    cmapclw.setSize(10)
    cmapclw.draw(window)    
    ...
    airpcmap=Image(Point(top_left_x/2 + 200,650),'airpressurecmapresize.png')
    airpcmap.draw(window)
    
    cmapairp = Text(Point(top_left_x/2,650),"AirPressure")
    cmapairp.setSize(10)
    cmapairp.draw(window)    
    
    airprange1=Text(Point(top_left_x/2 +83,650),"0 hPa")
    airprange2=Text(Point(top_left_x/2 +308,650),"120 hPa")
    ...
    wvcmap=Image(Point(top_left_x/2 + 200,680),'windspeedcmapresize.png')
    wvcmap.draw(window)
    
    cmapwv = Text(Point(top_left_x/2,680),"Wind Speed")
    cmapwv.setSize(10)
    cmapwv.draw(window)    
    
    wvrange1=Text(Point(top_left_x/2 +87,680),"0 knots")
    wvrange2=Text(Point(top_left_x/2 +308,680),"30 knots")
    wvrange1.setSize(10)
    wvrange2.setSize(10)
...
##########Parameters horizontal text labels TIME HOURS TEXT
    ...
    psimage.save(f'WX {datetime.date.today()}.png',quality=800)
    window.getMouse()
    window.close()
...
# darkness=[]
# for hour in today:
#     if (hour[11]=='0' and (hour[12]=='0' or hour[12]=='1' or hour[12]=='2' or hour[12]=='3' or hour[12]=='4' or hour[12]=='5')) or hour[11]=='2' or (hour[11]=='1' and hour[11]=='9'):
#         darkness.append('navy')
#     if (hour[11]=='1' and hour[12]=='6') or hour[12]=='7' or (hour[11]=='0' and hour[12]=='8') or (hour[11]=='0' and hour[12]=='9') or (hour[11]=='1' and (hour[12]=='0' or hour[12] =='1' or hour[12]=='2' or hour[12]=='3' or hour[12]=='4' or hour[12]=='5')):
#         darkness.append("gold")
#     if (hour[11] =='0' and hour[12] =='6') or (hour[11] =='1' and hour[12]=='8'):
#         darkness.append('orange')
# print(darkness)
# %%
